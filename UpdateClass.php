...
<head>
    <title>RISHTON ACADEMY - UPDATE CLASS</title>
  ...
  <hr> <h1>UPDATE CLASS</h1> <hr>
        ...
        <table >
          ...
          <tr class="input">
            ...
            <td>
              <label for="classid">Select Class ID to Update Data:</label><br>
              <select name="classid">
              <?php
            ...
            <tr class="input">
              <td>
                ...
                <input type="text" name="classname" placeholder="Class Name"  pattern="[A-Za-z ]{1,255}" required>
              </td>
              <td>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Class SET ClassName='$classname', Capacity='$capacity' 
