...
<head>
    <title>RISHTON ACADEMY - VIEW PARENTS</title>
	...
	<hr><h3>ALL PARENTS</h3><hr>
		...
		<table>
			...
			<tr>
				...
				<th width="250px">Type<br><hr></th>
                
			</tr>
				
			<?php
			
			$sql = mysqli_query($link, "SELECT ParentID, Name, Address, Phone_number, Email, Type  FROM Parents");
