...
<head>
    <title>RISHTON ACADEMY - ADD PARENTS</title>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Parents (Name,Address,Phone_number,Email,Type) VALUES ('$name','$address','$phone','$email','$type')";
