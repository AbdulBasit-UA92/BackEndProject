...
<head>
    <title>RISHTON ACADEMY - ADD TEACHERS</title>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Teachers (Name,Address,Email,Phone_number,Background_chk) VALUES ('$name','$address','$email','$phonenumber','$background')";
