...
<head>
    <title>RISHTON ACADEMY - DELETE LIBRARY</title>
...
if ($link === false) {
  ...
  $sqld = "SELECT LibraryID FROM Library";
  $library = mysqli_query($link, $sqld);

?>



  <hr> <h1>DELETE LIBRARY</h1> <hr>

        <table >
          <form method="post" action="DeleteLibrary.php">
          <tr class="input">
            <td>
