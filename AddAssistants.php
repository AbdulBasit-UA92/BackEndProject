...
<head>
    <title>RISHTON ACADEMY - ADD ASSISTANTS</title>
...
?>
  ...
  <hr> <h1>ADD ASSISTANTS</h1> <hr>

        <table >
          <form method="post" action="AddAssistants.php">
            <tr class="input">
              <td>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Teaching_assistants (Name,Address,Phone_number,TeacherID) VALUES ('$name','$address','$phone','$teacherid')";
