...
<head>
    <title>RISHTON ACADEMY - VIEW ASSISTANTS</title>
...
<div style="margin: 20px;">
	...
	<table>
		...
		$sql = mysqli_query($link, "SELECT AssistantID, Name, Address, Phone_number, TeacherID FROM Teaching_assistants");
