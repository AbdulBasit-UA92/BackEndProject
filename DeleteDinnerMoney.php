...
<head>
    <title>RISHTON ACADEMY - DELETE DINNER MONEY</title>
...
if ($link === false) {
  ...
  $sqld = "SELECT DinnerMoneyID FROM DinnerMoney";
  $dinnermoney = mysqli_query($link, $sqld);

?>



  <hr> <h1>DELETE DINNER MONEY</h1> <hr>

        <table >
          <form method="post" action="DeleteDinnerMoney.php">
          <tr class="input">
            <td>
              <label for="dinnermoneyid">DinnerMoney ID:</label><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM DinnerMoney WHERE DinnerMoneyID = '$dinnermoneyid' ";  
