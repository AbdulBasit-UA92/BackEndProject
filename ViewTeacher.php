...
<head>
    <title>RISHTON ACADEMY - VIEW TEACHERS</title>
...
<div style="margin: 20px;">
	<hr><h3>ALL TEACHERS</h3><hr>
		...
		<table>
			...
			$sql = mysqli_query($link, "SELECT TeacherID, Name, Address, Email, Phone_number, Background_chk  FROM Teachers");
