...
<head>
    <title>RISHTON ACADEMY - UPDATE LIBRARY</title>
...
if ($link === false) {
  ...
  $sqlb = "SELECT LibraryID FROM Library";
  $library = mysqli_query($link, $sqlb);

?>

  <hr> <h1>UPDATE LIBRARY</h1> <hr>

        <table >
          <form method="post" action="UpdateLibrary.php">
          <tr class="input">
            <td>
            ...
            <tr class="input">
              <td>
                ...
                <input type="text" name="author" placeholder="Book Author" pattern="[A-Za-z ]{1,255}" required>
              </td>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Library SET Title='$title', Year='$year' , Author = '$author'
