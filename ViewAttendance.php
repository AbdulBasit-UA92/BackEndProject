...
<head>
    <title>RISHTON ACADEMY - VIEW ATTENDANCE</title>
...
<div style="margin: 20px;">
	...
	<table>
		...
		<tr>
			...
			<th width="250px">Attendance Month<br><hr></th>
            <th width="250px">Average Attendance<br><hr></th>
            
		</tr>
			
		<?php
		
		$sql = mysqli_query($link, "SELECT AttendanceID, StudentID, Month, Average FROM Attendance");
