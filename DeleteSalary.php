...
<head>
    <title>RISHTON ACADEMY - DELETE SALARY</title>
...
if ($link === false) {
  ...
  $sqld = "SELECT SalaryID FROM Salary";
  $salary = mysqli_query($link, $sqld);

?>



  <hr> <h1>DELETE SALARY</h1> <hr>

        <table >
          <form method="post" action="DeleteSalary.php">
          <tr class="input">
            <td>
