...
<head>
    <title>RISHTON ACADEMY - ADD STUDENTS/PARENTS</title>
...
?>
  ...
  <hr> <h1>ADD STUDENTS/PARENTS RELATIONSHIP</h1> <hr>

        <table >
          <form method="post" action="StudentParent.php">
          <tr class="input">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO StudentParent (StudentID,ParentID) VALUES ('$studentid','$parentid')";
