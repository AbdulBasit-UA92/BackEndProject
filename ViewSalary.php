...
<head>
    <title>RISHTON ACADEMY - VIEW SALARY</title>
...
<div style="margin: 20px;">
	...
	<table>
		...
		<tr>
			...
			<th width="250px">Amount<br><hr></th>
		</tr>
			
		<?php
		
		$sql = mysqli_query($link, "SELECT SalaryID, TeacherID, SalaryAmount FROM Salary");
		while ($row = $sql->fetch_assoc()){
		echo "
		<tr>
			<th>{$row['SalaryID']}</th>
			<th>{$row['TeacherID']}</th>
			<th>{$row['SalaryAmount']}</th>
		</tr>";
		}
		?>
	   </table>	
