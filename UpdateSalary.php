...
<head>
    <title>RISHTON ACADEMY - UPDATE SALARY</title>
...
$sqla = "SELECT SalaryID FROM Salary";
$salary = mysqli_query($link, $sqla);

$sqlb = "SELECT TeacherID FROM Teachers";
$teacher = mysqli_query($link, $sqlb);
?>

  <hr> <h1>UPDATE SALARY</h1> <hr>
            ...
            <td>
              ...
              <?php
                while ($row = mysqli_fetch_array(
                        $salary,MYSQLI_ASSOC)):;
                ?>
                <option value="<?php echo $row["SalaryID"];?>">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Salary SET SalaryAmount='$amount', TeacherID='$teacherid'
