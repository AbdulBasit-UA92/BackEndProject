...
<head>
    <title>RISHTON ACADEMY - ADD DINNER MONEY</title>
...
?>
  ...
  <hr> <h1>ADD DINNER MONEY</h1> <hr>

        <table >
          <form method="post" action="AddDinnerMoney.php">
            <tr class="input">
              <td>
                <label for="amount">Dinner Money Amount:</label><br>
                <input type="number" name="amount" placeholder="Dinner Money Amount" pattern="[A-Za-z ]{1,255}" required>
              </td>
              <td>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO DinnerMoney (Amount,Date,StudentID) VALUES ('$amount','$date','$studentid')";
