...
<head>
    <title>RISHTON ACADEMY - UPDATED TEACHERS</title>
          ...
          <tr class="input">
            ...
            <tr class="input">
              <td>
                ...
                <input type="text" name="teachername" placeholder="Teacher Name" pattern="[A-Za-z ]{1,255}" required>
              </td>
              <td>
            ...
            <tr class="input">
              <td>
                <label for="background">Background Check:</label><br>
                <input type="text" name="background" placeholder="Background Check" required>
              </td>
            </tr>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Teachers SET Name='$name', Address='$address' , Email = '$email', 
    Phone_number = '$phonenumber', Background_chk = '$background'
