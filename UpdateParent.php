...
<head>
    <title>RISHTON ACADEMY - UPDATE PARENTS</title>
...
?>
  ...
  <hr> <h1>UPDATE PARENTS</h1> <hr>
        ...
        <table >
          ...
          <tr class="input">
              <td>
                <label for="parentname">Teacher Name:</label><br>
                <input type="text" name="parentname" placeholder="Parent Name" pattern="[A-Za-z ]{1,255}" required>
              </td>
              <td>
            ...
            <tr class="input">
              <td>
                <label for="parenttype">Parent Type:</label><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Parents SET Name='$name', Address='$address' , Phone_number = '$phone', 
