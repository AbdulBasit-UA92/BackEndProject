...
<head>
    <title>RISHTON ACADEMY - VIEW DINNER MONEY</title>
...
<div style="margin: 20px;">
	<hr><h3>ALL DINNER MONEY</h3><hr>
	
	<table>
	
		<tr>
			<th width="150px">Dinner Money ID<br><hr></th>
            <th width="250px">Student ID<br><hr></th>
			<th width="250px">Dinner Money Amount<br><hr></th>	
			<th width="250px">Dinner Money Date<br><hr></th>

		</tr>
			
		<?php
		
		$sql = mysqli_query($link, "SELECT DinnerMoneyID, StudentID, Amount, Date FROM DinnerMoney");
