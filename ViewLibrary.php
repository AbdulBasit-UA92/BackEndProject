...
<head>
    <title>RISHTON ACADEMY - VIEW LIBRARY</title>
...
<div style="margin: 20px;">
	<hr><h3>ALL LIBRARY BOOKS</h3><hr>
	
	<table>
	
		<tr>
			<th width="150px">Library ID<br><hr></th>
			<th width="250px">Book Title<br><hr></th>	
			<th width="250px">Book Year<br><hr></th>
            <th width="250px">Book Author<br><hr></th>

		</tr>
			
		<?php
		
		$sql = mysqli_query($link, "SELECT LibraryID, Title, Year, Author FROM Library");
