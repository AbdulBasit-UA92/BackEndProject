...
<head>
    <title>RISHTON ACADEMY - VIEW STUDENTS/PARENTS</title>
...
<div style="margin: 20px;">
	<hr><h3>ALL STUDENTS / PARENTS</h3><hr>
		<table>
			...
			$sql = mysqli_query($link, "SELECT StudentParent.ParentID AS ParentID, Parents.Name AS ParentName, 
            StudentParent.StudentID, Students.Name AS StudentName 
            FROM StudentParent
            INNER JOIN Parents ON StudentParent.ParentID = Parents.ParentID
