...
<head>
    <title>RISHTON ACADEMY - VIEW STUDENTS</title>
	...
	<hr><h3>ALL STUDENTS</h3><hr>
		...
		<table>
			...
			<tr>
				...
				<th width="250px">Date Of Birth<br><hr></th>
			...
			$sql = mysqli_query($link, "SELECT StudentID, Name, Address, Gender, DOB, Medical_inf  FROM Students");
