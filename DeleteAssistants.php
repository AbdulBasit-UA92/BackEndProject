...
<head>
    <title>RISHTON ACADEMY - DELETE ASSISTANTS</title>
...
if ($link === false) {
  ...
  $sqld = "SELECT AssistantID FROM Teaching_assistants";
  $assistant = mysqli_query($link, $sqld);

?>



  <hr> <h1>DELETE ASSISTANTS</h1> <hr>

        <table >
          <form method="post" action="DeleteAssistants.php">
          <tr class="input">
            <td>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM Teaching_assistants WHERE AssistantID = '$assistantid' ";  
