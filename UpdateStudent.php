...
<head>
    <title>RISHTON ACADEMY - UPDATE STUDENTS</title>
...
if ($link === false) {
  ...
  $sqld = "SELECT StudentID FROM Students";
  $student = mysqli_query($link, $sqld);
?>



  <hr> <h1>UPDATE STUDENTS</h1> <hr>

        <table >
          <form method="post" action="UpdateStudent.php">
          <tr class="input">
            <td>
              <label for="studentid">Select Student ID to Update Data:</label><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Students SET Name='$name', Address='$address' , Gender = '$gender', DOB = '$DOB', 
    Medical_inf = '$medical', ClassID = '$classid', Teacherid = '$teacherid', LibraryID = '$libraryid'  
    ...
    if (mysqli_query($link, $sql)) {
      ...
      echo '<script type="text/javascript">
      window.onload = function () { alert("ERROR UPDATING RECORD"); } 
      </script>';
    }
