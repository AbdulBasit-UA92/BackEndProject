...
<head>
    <title>RISHTON ACADEMY - UPDATE ATTENDANCE</title>
...
$sqlb = "SELECT StudentID FROM Students";
$student = mysqli_query($link, $sqlb);

$sqla = "SELECT AttendanceID FROM Attendance";
$attendance = mysqli_query($link, $sqla);

?>

  <hr> <h1>UPDATE ATTENDANCE</h1> <hr>
        ...
        <table >
          ...
          <tr class="input">
            ...
            <tr class="input">
              <td>
                <label for="average">Average Attendance:</label><br>
                <input type="number" name="average" placeholder="Average" required>
              </td>
            </tr>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Attendance SET Month='$month', Average='$average' , StudentID = '$studentid'
